...
export class OdspDelayLoadedDeltaStream {
    ...
    async connectToDeltaStream(client) {
        ...
        return getWithRetryForTokenRefresh(async (options) => {
            ...
            if (finalWebsocketToken === null) {
                throw this.annotateConnectionError(new NonRetryableError("Websocket token is null", OdspErrorTypes.fetchTokenError, {
                    driverVersion,
    ...
    async createDeltaConnection(tenantId, documentId, token, client, webSocketUrl, connectionId) {
        ...
        const connection = await OdspDocumentDeltaConnection.create(tenantId, documentId, token, client, webSocketUrl, this.mc.logger, 60000, this.epochTracker, this.socketReferenceKeyPrefix, connectionId);
