...
exports.getLocatorFromOdspUrl = exports.storeLocatorInOdspUrl = exports.locatorQueryParamName = exports.encodeOdspFluidDataStoreLocator = void 0;
 ...
 * @beta
 */
function encodeOdspFluidDataStoreLocator(locator) {
    ...
    return (0, client_utils_1.fromUtf8ToBase64)(locatorSerialized);
}
...
function decodeOdspFluidDataStoreLocator(encodedLocatorValue, siteOriginUrl, requireFluidSignature = true) {
    const locatorInfo = new URLSearchParams((0, client_utils_1.fromBase64ToUtf8)(encodedLocatorValue));
 ...
 * @beta
 */
exports.locatorQueryParamName = "nav";
/**
 ...
 * @beta
 */
function storeLocatorInOdspUrl(url, locator) {
    ...
    url.searchParams.set(exports.locatorQueryParamName, encodedLocatorValue);
}
exports.storeLocatorInOdspUrl = storeLocatorInOdspUrl;
/**
 ...
 * @beta
 */
function getLocatorFromOdspUrl(url, requireFluidSignature = true) {
    // NOTE: No need to apply decodeURIComponent when accessing query params via URLSearchParams class.
    const encodedLocatorValue = url.searchParams.get(exports.locatorQueryParamName);
    ...
    const siteOriginUrl = url.origin.toLowerCase() === constants_js_1.OdcFileSiteOrigin ? constants_js_1.OdcApiSiteOrigin : url.origin;
    return decodeOdspFluidDataStoreLocator(encodedLocatorValue, siteOriginUrl, requireFluidSignature);
}
exports.getLocatorFromOdspUrl = getLocatorFromOdspUrl;
