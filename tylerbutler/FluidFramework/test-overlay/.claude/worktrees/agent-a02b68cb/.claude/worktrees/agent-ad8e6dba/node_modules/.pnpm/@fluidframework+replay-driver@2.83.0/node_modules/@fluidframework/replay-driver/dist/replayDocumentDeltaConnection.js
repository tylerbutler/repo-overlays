...
class ReplayControllerStatic extends replayController_js_1.ReplayController {
     ...
     */
    constructor(replayFrom, replayTo, unitIsTime) {
        super();
    ...
    async initStorage(documentService) {
        return true;
    }
    ...
    async replay(emitter, fetchedOps) {
...
class ReplayDocumentDeltaConnection extends client_utils_1.TypedEventEmitter {
     ...
     */
    static create(documentStorageService, controller) {
        const connection = {
     ...
     */
    async fetchAndEmitOps(documentStorageService, controller) {
        let done;
