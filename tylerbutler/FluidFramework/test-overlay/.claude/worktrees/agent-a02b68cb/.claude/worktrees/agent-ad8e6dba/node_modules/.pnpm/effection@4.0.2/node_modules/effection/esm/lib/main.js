 ...
 */
export function* exit(status, message) {
...
export async function main(body) {
    let hardexit = (_status) => { };
    let result = await run(() => callcc(function* (resolve) {
        ...
        try {
            ...
            yield* withHost({
                ...
                *node() {
                    ...
                    let { default: process } = yield* call(() => import(/* webpackIgnore: true */ "node:process"));
            ...
            yield* resolve({ status: 1, error: error });
        }
        finally {
...
const ExitContext = createContext("exit");
function* withHost(op) {
    let global = dntShim.dntGlobalThis;
    ...
    else if (Object.prototype.toString.call(typeof global.process !== "undefined" ? global.process : 0) === "[object process]") {
