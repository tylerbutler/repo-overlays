...
export class OdspDocumentDeltaConnection extends DocumentDeltaConnection {
    ...
    token, client, url, telemetryLogger, timeoutMs, epochTracker, socketReferenceKeyPrefix, connectionId = uuid()) {
    ...
    async flush() {
        ...
        this.flushDeferred = new Deferred();
    ...
    async initialize(connectMessage, timeout) {
        ...
        this.connectionInitializeDeferredP = new Deferred();
        super
        ...
        switch (event) {
            ...
            case "signal": {
                ...
                super.addTrackedListener(event, (msg, documentId) => {
                    ...
                    assert(documentId !== undefined, 0xa65 /* documentId is required when multiplexing is enabled. */);
