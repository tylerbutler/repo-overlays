...
exports.OdspDocumentStorageServiceBase = void 0;
...
class OdspDocumentStorageServiceBase {
    constructor(config) {
        ...
        const maximumCacheDurationMsInEffect = (config.getBoolean("Fluid.Driver.Odsp.TestOverride.DisableSnapshotCache")
            ? 0
            : internal_3.maximumCacheDurationMs);
        this.policies = {
            // By default, ODSP tells the container not to prefetch/cache.
            caching: internal_2.LoaderCachingPolicy.NoCaching,
            maximumCacheDurationMs: maximumCacheDurationMsInEffect,
        };
    }
    set ops(ops) {
        (0, internal_1.assert)(this._ops === undefined, 0x0a5 /* "Trying to set ops when they are already set!" */);
        this._ops = ops;
    }
    get ops() {
        return this._ops;
    ...
    initializeFromSnapshot(odspSnapshotCacheValue, cacheOps = true, cacheSnapshot = true) {
        ...
        if (snapshotTree) {
            id = snapshotTree.id;
            (0, internal_1.assert)(id !== undefined, 0x221 /* "Root tree should contain the id" */);
            if (cacheSnapshot) {
...
exports.OdspDocumentStorageServiceBase = OdspDocumentStorageServiceBase;
