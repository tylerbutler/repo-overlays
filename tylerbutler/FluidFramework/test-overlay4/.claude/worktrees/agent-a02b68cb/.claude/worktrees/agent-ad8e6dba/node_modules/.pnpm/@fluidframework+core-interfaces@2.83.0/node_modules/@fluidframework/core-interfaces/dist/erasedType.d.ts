 ...
 * @internal
 */
export declare abstract class ErasedTypeImplementation<TInterface extends ErasedBaseType> extends ErasedBaseType<TInterface extends ErasedBaseType<infer Name> ? Name : never> {
    protected readonly brand: (dummy: never) => TInterface extends ErasedBaseType<infer Name> ? Name : never;
    protected constructor();
    /**
    ...
    static [Symbol.hasInstance]<TThis extends {
        prototype: object;
    }>(this: TThis, value: unknown): value is InstanceTypeRelaxed<TThis>;
    /**
     ...
     */
    static narrow<TThis extends {
        prototype: object;
    }>(this: TThis, value: ErasedBaseType | InstanceTypeRelaxed<TThis>): asserts value is InstanceTypeRelaxed<TThis>;
    /**
     * Upcasts the instance to the erased interface type.
     * @remarks
     * This is mainly useful when inferring the interface type is required.
     */
    upCast<TThis extends TInterface>(this: TThis): TInterface;
}
/**
