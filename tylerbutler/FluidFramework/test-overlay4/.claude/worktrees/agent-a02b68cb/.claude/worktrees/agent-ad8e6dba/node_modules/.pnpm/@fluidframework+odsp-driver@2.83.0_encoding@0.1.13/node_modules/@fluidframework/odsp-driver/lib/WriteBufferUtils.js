...
import { BlobCore, MarkerCodes, MarkerCodesEnd, MarkerCodesStart, NodeCore, codeToBytesMap, getValueSafely, } from "./zipItDataRepresentationUtils.js";
/**
 ...
 */
export function calcLength(numArg) {
    if (numArg === 0) {
        return 0;
    }
    let num = numArg;
 ...
 * @param dictionary - Const strings dictionary to be used while serializing.
 */
function serializeNodeCore(buffer, nodeCore, dictionary) {
...
class NodeCoreSerializer extends NodeCore {
    ...
    serialize(buffer) {
        serializeNodeCore(buffer, this, new Map());
    }
}
