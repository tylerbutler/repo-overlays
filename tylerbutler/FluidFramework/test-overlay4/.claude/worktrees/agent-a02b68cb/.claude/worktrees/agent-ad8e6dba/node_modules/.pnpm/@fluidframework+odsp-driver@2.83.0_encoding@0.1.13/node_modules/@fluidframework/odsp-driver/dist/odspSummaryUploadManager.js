...
exports.OdspSummaryUploadManager = void 0;
...
class OdspSummaryUploadManager {
    constructor(snapshotUrl, getAuthHeader, logger, epochTracker, relayServiceTenantAndSessionId) {
        ...
        this.mc = (0, internal_3.loggerToMonitoringContext)(logger);
    }
    ...
    async writeSummaryTreeCore(parentHandle, referenceSequenceNumber, tree) {
        const containsProtocolTree = (0, internal_2.isCombinedAppAndProtocolSummary)(tree);
        ...
        return (0, odspUtils_js_1.getWithRetryForTokenRefresh)(async (options) => {
            ...
            const method = "POST";
            const authHeader = await this.getAuthHeader({ ...options, request: { url, method } }, "WriteSummaryTree");
    ...
    async convertSummaryToSnapshotTree(parentHandle, tree, rootNodeName, markUnreferencedNodes = this.mc.config.getBoolean("Fluid.Driver.Odsp.MarkUnreferencedNodes") ?? true) {
        ...
        for (const key of keys) {
            (0, internal_1.assert)(!key.includes("/"), 0x9cd /* id should not include slashes */);
            ...
            switch (summaryObject.type) {
                ...
                case driver_definitions_1.SummaryType.Blob: {
                    value =
                        typeof summaryObject.content === "string"
                            ...
                            : {
                                type: "blob",
                                content: (0, client_utils_1.Uint8ArrayToString)(summaryObject.content, "base64"),
                                encoding: "base64",
                            };
                    blobs++;
                    break;
                ...
                default: {
                    (0, internal_1.unreachableCase)(summaryObject, `Unknown type: ${summaryObject.type}`);
                }
            }
            const baseEntry = {
                path: key,
            ...
            let entry;
            if (value) {
                (0, internal_1.assert)(id === undefined, 0x0ad /* "Snapshot entry has both a tree value and a referenced id!" */);
                entry = {
                    value,
                    ...baseEntry,
                    unreferenced,
...
exports.OdspSummaryUploadManager = OdspSummaryUploadManager;
