 ...
 */
export declare const mockifyMockKey: unique symbol;
/**
 ...
 * ```
 */
export declare function mockify<T extends (...args: any[]) => unknown>(fn: T): Mockable<T>;
export declare namespace mockify {
    var key: typeof mockifyMockKey;
}
//# sourceMappingURL=mockify.d.ts.map