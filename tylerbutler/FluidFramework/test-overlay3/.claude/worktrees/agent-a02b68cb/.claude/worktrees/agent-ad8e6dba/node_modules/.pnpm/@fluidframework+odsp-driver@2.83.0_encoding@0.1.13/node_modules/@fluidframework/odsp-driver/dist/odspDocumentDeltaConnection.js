...
class SocketReference extends client_utils_1.TypedEventEmitter {
    ...
    removeSocketIoReference() {
        (0, internal_1.assert)(this.references > 0, 0x09f /* "No more socketIO refs to remove!" */);
        this.references--;
        ...
        if (this.references === 0 && this.delayDeleteTimeout === undefined) {
            this.delayDeleteTimeout = setTimeout(() => {
                ...
                (0, internal_1.assert)(this.references === 0, 0x0a0 /* "Unexpected socketIO references on timeout" */);
                this.closeSocket();
    ...
    constructor(key, socket) {
        ...
        this._socket = socket;
        (0, internal_1.assert)(!SocketReference.socketIoSockets.has(key), 0x220 /* "socket key collision" */);
    ...
    closeSocket(error) {
        ...
        this.clearTimer();
        (0, internal_1.assert)(SocketReference.socketIoSockets.get(this.key) === this, 0x0a1 /* "Socket reference set unexpectedly does not point to this socket!" */);
        ...
        this.emit("disconnect", error ??
            (0, internal_3.createGenericNetworkError)("Socket closed without error", { canRetry: true }, { driverVersion: packageVersion_js_1.pkgVersion }), undefined /* clientId */);
        // We should not have any users now, assuming synchronous disconnect flow in response to
        // "disconnect" event
        (0, internal_1.assert)(this.references === 0, 0x412 /* Nobody should be connected to this socket at this point! */);
        socket.disconnect();
    }
    get disconnected() {
 ...
 */
class OdspDocumentDeltaConnection extends internal_2.DocumentDeltaConnection {
    /**
    ...
    token, client, url, telemetryLogger, timeoutMs, epochTracker, socketReferenceKeyPrefix, connectionId = (0, uuid_1.v4)()) {
        const mc = (0, internal_4.loggerToMonitoringContext)(telemetryLogger);
     ...
     */
    requestOps(from, to) {
        (0, internal_1.assert)(!this.socketReference?.disconnected, 0x413 /* non-active socket */);
        // Given that to is exclusive, we should be asking for at least something!
        (0, internal_1.assert)(to > from, 0x272 /* "empty request" */);
        ...
        if (this.getOpsMap.size >= 5) {
            ...
            this.logger.sendErrorEvent({
                ...
                duration: (0, client_utils_1.performanceNow)() - payloadToDelete.start,
            });
    ...
    async flush() {
        (0, internal_1.assert)(!this.socketReference?.disconnected, 0x414 /* non-active socket */);
        // back-compat: remove cast to any once latest version of IConnected is consumed
        // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-member-access
        ...
        this.flushDeferred = new internal_1.Deferred();
        return this.flushDeferred.promise;
    }
    async initialize(connectMessage, timeout) {
        (0, internal_1.assert)(!this.socketReference?.disconnected, 0x415 /* non-active socket */);
        ...
        this.addTrackedListener("get_ops_response", (result) => {
            ...
            if (data !== undefined || result.nonce.startsWith(this.requestOpsNoncePrefix)) {
                ...
                const common = {
                    ...
                    from: data?.from,
                    to: data?.to,
                    duration: data === undefined ? undefined : (0, client_utils_1.performanceNow)() - data.start,
                };
        ...
        this.connectionInitializeDeferredP = new internal_1.Deferred();
        super
        ...
        switch (event) {
            ...
            case "signal": {
                ...
                super.addTrackedListener(event, (msg, documentId) => {
                    ...
                    (0, internal_1.assert)(documentId !== undefined, 0xa65 /* documentId is required when multiplexing is enabled. */);
                    if (documentId !== this.documentId) {
                        return;
                    }
                    const msgs = Array.isArray(msg) ? msg : [msg];
                    const filteredMsgs = msgs.filter((m) => !m.targetClientId || m.targetClientId === this.clientId);
    ...
    closeSocketCore(error) {
        ...
        (0, internal_1.assert)(socket !== undefined, 0x416 /* reentrancy not supported in close socket */);
        socket.closeSocket(error);
        (0, internal_1.assert)(this.socketReference === undefined, 0x417 /* disconnect flow did not work correctly */);
    }
    /**
    ...
    disconnectCore(err) {
        const socket = this.socketReference;
        (0, internal_1.assert)(socket !== undefined, 0x0a2 /* "reentrancy not supported!" */);
        ...
        if (this.connectionInitializeDeferredP !== undefined &&
