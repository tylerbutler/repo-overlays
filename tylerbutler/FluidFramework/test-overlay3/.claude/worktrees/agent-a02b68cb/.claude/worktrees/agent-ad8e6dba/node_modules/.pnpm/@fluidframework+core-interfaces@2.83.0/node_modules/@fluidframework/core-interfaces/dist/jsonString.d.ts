 ...
 */
type BrandForJsonString<T> = InternalUtilityTypes.IfSameType<DistributeJsonStringBrand<T> extends JsonStringBrand<infer U> ? U : never, T, DistributeJsonStringBrand<T>, JsonStringBrand<T>>;
/**
 ...
 * @internal
 */
export declare const JsonStringify: <T, Options extends JsonStringifyOptions = Record<never, never>>(value: JsonSerializable<T, Pick<Options, Extract<keyof JsonStringifyOptions, keyof Options>>>) => JsonString<T>;
/**
 ...
 * @internal
 */
export declare const JsonParse: <T extends JsonString<unknown>>(text: T) => T extends JsonString<infer U> ? JsonDeserialized<U> : unknown;
export {};
