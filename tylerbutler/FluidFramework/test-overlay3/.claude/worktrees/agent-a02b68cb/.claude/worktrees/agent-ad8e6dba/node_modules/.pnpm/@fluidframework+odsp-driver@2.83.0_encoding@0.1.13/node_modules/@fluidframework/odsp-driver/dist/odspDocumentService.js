...
class OdspDocumentService extends client_utils_1.TypedEventEmitter {
     ...
     */
    static async create(resolvedUrl, getAuthHeader, 
    // eslint-disable-next-line @rushstack/no-new-null
    getWebsocketToken, logger, cache, hostPolicy, epochTracker, socketReferenceKeyPrefix, clientIsSummarizer) {
        return new OdspDocumentService((0, odspUtils_js_1.getOdspResolvedUrl)(resolvedUrl), getAuthHeader, getWebsocketToken, logger, cache, hostPolicy, epochTracker, socketReferenceKeyPrefix, clientIsSummarizer);
    }
    /**
     ...
     * @param socketReferenceKeyPrefix - (optional) prefix to isolate socket reuse cache
     */
    constructor(odspResolvedUrl, getAuthHeader, getWebsocketToken, logger, cache, hostPolicy, epochTracker, socketReferenceKeyPrefix, clientIsSummarizer) {
        super();
        ...
        this.mc = (0, internal_2.createChildMonitoringContext)({
            ...
            properties: {
                all: {
                    odc: (0, odspUrlHelper_js_1.hasOdcOrigin)(new URL(this.odspResolvedUrl.endpoints.snapshotStorageUrl)),
                },
            },
        });
    ...
    async connectToStorage() {
        ...
        if (!this.storageManager) {
            this.storageManager = new odspDocumentStorageManager_js_1.OdspDocumentStorageService(this.odspResolvedUrl, this.getAuthHeader, this.mc.logger, true, this.cache, this.hostPolicy, this.epochTracker, 
            // flushCallback
            async () => {
    ...
    async connectToDeltaStorage() {
        ...
        const service = new odspDeltaStorageService_js_1.OdspDeltaStorageService(this.odspResolvedUrl.endpoints.deltaStorageUrl, this.getAuthHeader, this.epochTracker, this.mc.logger);
        ...
        }, (ops) => this.opsReceived(ops), () => this.storageManager);
    }
    /**
    ...
    async getDelayLoadedDeltaStream() {
        (0, internal_1.assert)(this.odspSocketModuleLoaded === false, 0x507 /* Should be loaded only once */);
        ...
        this.odspDelayLoadedDeltaStream = new module.OdspDelayLoadedDeltaStream(this.odspResolvedUrl, this._policies, this.getAuthHeader, this.getWebsocketToken, this.mc, this.cache, this.hostPolicy, this.epochTracker, (ops) => this.opsReceived(ops), (metadata) => this.emit("metadataUpdate", metadata), this.socketReferenceKeyPrefix);
...
exports.OdspDocumentService = OdspDocumentService;
//# sourceMappingURL=odspDocumentService.js.map