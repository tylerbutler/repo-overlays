...
export class OdspDocumentService extends TypedEventEmitter {
    ...
    getWebsocketToken, logger, cache, hostPolicy, epochTracker, socketReferenceKeyPrefix, clientIsSummarizer) {
        return new OdspDocumentService(getOdspResolvedUrl(resolvedUrl), getAuthHeader, getWebsocketToken, logger, cache, hostPolicy, epochTracker, socketReferenceKeyPrefix, clientIsSummarizer);
    }
    /**
    ...
    async connectToStorage() {
        ...
        if (!this.storageManager) {
            this.storageManager = new OdspDocumentStorageService(this.odspResolvedUrl, this.getAuthHeader, this.mc.logger, true, this.cache, this.hostPolicy, this.epochTracker, 
            // flushCallback
            async () => {
    ...
    async connectToDeltaStorage() {
        ...
        const service = new OdspDeltaStorageService(this.odspResolvedUrl.endpoints.deltaStorageUrl, this.getAuthHeader, this.epochTracker, this.mc.logger);
    ...
    get opsCache() {
        ...
        this._opsCache = new OpsCache(seqNumber, this.mc.logger, 
        // ICache
        {
