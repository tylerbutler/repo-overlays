 ...
 * @alpha
 */
export async function detectIndentation(filePath, defaultIndentation = DEFAULT_INDENTATION) {
    try {
 ...
 * @alpha
 */
export function detectIndentationFromContent(content, defaultIndentation = DEFAULT_INDENTATION) {
