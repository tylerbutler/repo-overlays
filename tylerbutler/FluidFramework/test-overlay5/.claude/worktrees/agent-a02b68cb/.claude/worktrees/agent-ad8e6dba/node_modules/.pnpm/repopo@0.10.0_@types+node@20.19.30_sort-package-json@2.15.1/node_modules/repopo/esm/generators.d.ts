 ...
 * @alpha
 */
export type PolicyCreatorFunction<C = undefined> = (args: PolicyDefinition<C>) => PolicyDefinition<C>;
/**
 * The definition of a constructor function that returns a RepoPolicy.
 *
 * @alpha
 */
export type PolicyCreatorConstructor<C = undefined> = new (args: PolicyDefinition<C>) => PolicyDefinition<C>;
/**
 ...
 * @alpha
 */
export declare function isGeneratorFunction(fn: Function): fn is GeneratorFunction;
