...
exports.downloadSnapshot = exports.validateBlobsAndTrees = exports.getTreeStats = exports.fetchSnapshotWithRedeem = exports.fetchSnapshot = exports.SnapshotFormatSupportType = void 0;
...
const mockify_js_1 = require("./mockify.js");
...
async function fetchSnapshotWithRedeem(odspResolvedUrl, storageTokenFetcher, snapshotOptions, forceAccessTokenViaAuthorizationHeader, logger, snapshotDownloader, putInCache, removeEntries, loadingGroupIds, enableRedeemFallback) {
    ...
    return fetchLatestSnapshotCore(odspResolvedUrl, storageTokenFetcher, snapshotOptions, logger, snapshotDownloader, putInCache, loadingGroupIds, enableRedeemFallback)
        .catch(async (error) => {
...
async function redeemSharingLink(odspResolvedUrl, getAuthHeader, logger) {
    await internal_6.PerformanceEvent.timedExecAsync(logger, {
        ...
        const isRedemptionNonDurable = odspResolvedUrl.shareLinkInfo?.isRedemptionNonDurable === true;
        let redeemUrl;
...
async function fetchLatestSnapshotCore(odspResolvedUrl, getAuthHeader, snapshotOptions, logger, snapshotDownloader, putInCache, loadingGroupIds, enableRedeemFallback) {
    return (0, odspUtils_js_1.getWithRetryForTokenRefresh)(async (tokenFetchOptions) => {
        ...
        const internalFarmType = (0, odspUrlHelper_js_1.checkForKnownServerFarmType)(odspResolvedUrl.siteUrl);
        const isRedemptionNonDurable = odspResolvedUrl.shareLinkInfo?.isRedemptionNonDurable === true;
        ...
        return internal_6.PerformanceEvent.timedExecAsync(logger, perfEvent, async (event) => {
            ...
            try {
                switch (contentTypeToRead) {
                    case "application/json": {
                        let text;
                        [text, receiveContentTime] = await (0, odspUtils_js_1.measureP)(async () => odspResponse.content
                            .text()
                            .then((res) => {
                            if (res.length === 0) {
                        ...
                        let content;
                        [content, parseTime] = (0, odspUtils_js_1.measure)(() => JSON.parse(text));
                        validateBlobsAndTrees(content);
                        const snapshotContents = (0, odspSnapshotParser_js_1.convertOdspSnapshotToSnapshotTreeAndBlobs)(content);
                    ...
                    case "application/ms-fluid": {
                        let content;
                        [content, receiveContentTime] = await (0, odspUtils_js_1.measureP)(async () => odspResponse.content
                            .arrayBuffer()
                            .then((res) => {
                            if (res.byteLength === 0) {
                                (0, internal_4.throwOdspNetworkError)("Response from browser is empty", internal_4.fetchIncorrectResponse, odspResponse.content, // response
                        ...
                        if (slowTreeParseCodePaths - treeStructureCountWithGroupId > 10 ||
            ...
            if (!Number.isInteger(sequenceNumber) ||
                ...
                (0, internal_1.assert)(fluidEpoch !== undefined, 0x1e6 /* "Epoch  should be present in response" */);
                const value = {
                    ...snapshot,
            ...
            event.end({
                ...
                receiveContentTime,
                ...(0, internal_2.getW3CData)(response.requestUrl, "fetch"),
...
function validateBlobsAndTrees(snapshot) {
    (0, internal_1.assert)(snapshot.trees !== undefined, 0x200 /* "Returned odsp snapshot is malformed. No trees!" */);
    (0, internal_1.assert)(snapshot.blobs !== undefined, 0x201 /* "Returned odsp snapshot is malformed. No blobs!" */);
}
exports.validateBlobsAndTrees = validateBlobsAndTrees;
function getTreeStatsCore(snapshotTree, stats) {
...
exports.downloadSnapshot = (0, mockify_js_1.mockify)(async (odspResolvedUrl, getAuthHeader, tokenFetchOptions, loadingGroupIds, snapshotOptions, snapshotFormatFetchType, controller, epochTracker, scenarioName) => {
    ...
    if (epochTracker === undefined && odspResolvedUrl.isClpCompliantApp !== undefined) {
        header[contractsPublic_js_1.ClpCompliantAppHeader.isClpCompliantApp] =
    ...
    switch (snapshotFormatFetchType) {
        case SnapshotFormatSupportType.Binary: {
            headers.accept = `application/ms-fluid; v=${compactSnapshotParser_js_1.currentReadVersion}`;
            break;
        }
        default: {
...
function getEncodedShareUrl(url) {
    /**
