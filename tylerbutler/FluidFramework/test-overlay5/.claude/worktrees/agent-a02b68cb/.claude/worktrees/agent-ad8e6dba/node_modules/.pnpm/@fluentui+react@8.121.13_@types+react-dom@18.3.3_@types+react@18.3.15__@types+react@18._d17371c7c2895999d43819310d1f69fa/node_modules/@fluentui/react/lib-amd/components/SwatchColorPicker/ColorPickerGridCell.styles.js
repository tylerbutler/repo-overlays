define(["require", "exports", "../../Utilities", "../../Styling"], function (require, exports, Utilities_1, Styling_1) {
    ...
    var getStyles = function (props) {
        ...
        var theme = props.theme, disabled = props.disabled, selected = props.selected, circle = props.circle, isWhite = props.isWhite, _g = props.height, height = _g === void 0 ? DEFAULT_CELL_SIZE : _g, _h = props.width, width = _h === void 0 ? DEFAULT_CELL_SIZE : _h, borderWidth = props.borderWidth;
        ...
        return {
            ...
            colorCell: [
                ...
                circle && {
                    borderRadius: '50%',
                    selectors: (_b = {},
                        _b[".".concat(Utilities_1.IsFocusVisibleClassName, " &:focus::after, :host(.").concat(Utilities_1.IsFocusVisibleClassName, ") &:focus::after")] = {
                            outline: 'none',
