...
exports.convertOdspSnapshotToSnapshotTreeAndBlobs = void 0;
 ...
 */
function convertOdspSnapshotToSnapshotTreeAndBlobs(odspSnapshot) {
    const blobsWithBufferContent = new Map();
    if (odspSnapshot.blobs) {
        for (const blob of odspSnapshot.blobs) {
            (0, internal_1.assert)(blob.encoding === "base64" || blob.encoding === undefined, 0x0a4 /* Unexpected blob encoding type */);
            blobsWithBufferContent.set(blob.id, (0, client_utils_1.stringToBuffer)(blob.content, blob.encoding ?? "utf8"));
        }
    }
...
exports.convertOdspSnapshotToSnapshotTreeAndBlobs = convertOdspSnapshotToSnapshotTreeAndBlobs;
