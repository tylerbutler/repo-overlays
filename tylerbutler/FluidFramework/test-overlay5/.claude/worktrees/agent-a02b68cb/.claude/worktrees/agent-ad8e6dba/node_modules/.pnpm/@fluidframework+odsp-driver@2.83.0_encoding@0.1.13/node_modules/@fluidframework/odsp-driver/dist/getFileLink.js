 ...
 */
exports.getFileLink = (0, mockify_js_1.mockify)(async (getToken, resolvedUrl, logger) => {
    ...
    const fileLinkGenerator = async function () {
        ...
        (0, internal_1.assert)(fileLinkCore !== undefined, 0x292 /* "Unexpected undefined result from getFileLinkCore" */);
        return fileLinkCore;
    };
...
async function getFileLinkCore(getToken, odspUrlParts, logger, fileItem) {
    ...
    return internal_4.PerformanceEvent.timedExecAsync(logger, { eventName: "odspFileLink", requestName: "getSharingInformation" }, async (event) => {
        ...
        const fileLink = await (0, odspUtils_js_1.getWithRetryForTokenRefresh)(async (options) => {
            attempts++;
            const getAuthHeader = (0, odspUtils_js_1.toInstrumentedOdspStorageTokenFetcher)(logger, odspUrlParts, getToken);
