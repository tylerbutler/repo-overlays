 ...
 */
function isScopeAllowed(packageName, allowedScopes) {
 ...
 */
function isUnscopedPackageAllowed(packageName, unscopedPackages) {
...
export const PackageAllowedScopes = definePackagePolicy({
    ...
    description: "Ensures packages use only allowed npm scopes and package names.",
...
//# sourceMappingURL=PackageAllowedScopes.js.map