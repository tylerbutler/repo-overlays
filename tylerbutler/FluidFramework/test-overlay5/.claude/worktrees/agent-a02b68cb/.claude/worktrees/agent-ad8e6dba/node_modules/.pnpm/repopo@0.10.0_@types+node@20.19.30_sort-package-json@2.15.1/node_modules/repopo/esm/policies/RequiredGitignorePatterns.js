 ...
 */
function findMissingPatterns(patterns, lines) {
 ...
 */
function addPatternsToContent(content, missingPatterns) {
 ...
 */
function createGitignoreContent(patterns) {
 ...
 */
async function handleExistingGitignore(filePath, patterns, file, resolve) {
    ...
    if (resolve) {
        ...
        try {
            ...
            fixResult.errorMessages = [
                `Failed to update .gitignore: ${error.message}`,
            ];
        }
        return fixResult;
    }
 ...
 */
async function handleMissingGitignore(filePath, patterns, file, resolve) {
    const result = {
        name: RequiredGitignorePatterns.name,
        file,
        autoFixable: true,
    ...
    if (resolve) {
        ...
        try {
            ...
            fixResult.errorMessages = [
                `Failed to create .gitignore: ${writeError.message}`,
            ];
        }
        return fixResult;
    }
 ...
 * @alpha
 */
export const RequiredGitignorePatterns = makePolicyDefinition({
    name: "RequiredGitignorePatterns",
    description: "Ensures .gitignore contains required patterns to prevent committing sensitive files, dependencies, and build artifacts.",
    match: /^\.gitignore$/,
...
//# sourceMappingURL=RequiredGitignorePatterns.js.map