...
export function Uint8ArrayToString(arr: Uint8Array, encoding?: string): string {
	...
	return Buffer.isBuffer(arr) ? <span class="branch-0 cbranch-no" title="branch not covered" >arr.toString(encoding) </span>: Buffer.from(arr).toString(encoding);
}
&nbsp;
/**
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Tue Feb 14 2023 01:28:28 GMT+0000 (Coordinated Universal Time)
            </div>
        </div>
